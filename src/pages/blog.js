  ...
  return (
    <>
      ...
      <ArticleStyles className="post" id="beginning">
        <h1>Val Duron – A Trip to the Unknown Valley</h1>
        <h3>The Beginning</h3>

        <p>
          I should probably qualify the title of this by saying that Val Duron
          was unknown to me and obviously not to the numerous other people I saw
          during my journey and the owners of several rifugios (mountain
          restaurants), who presumably rely on the known’ness of their beautiful
          valley.
        </p>
        <p>
          In any event I discovered Val Duron by accident. A Sunday morning
          stroll had led me into Campitello, the adjacent village to Canazei. In
          my efforts to find an open cafe and a latte macchiato I had noticed a
          number of people driving and walking up a hill at the back of the
        ...
        <p>
          ...
          showed a route to ‘Val Duron’. Making their way up the snowy road were
          a number of ski tourers, a couple of hikers and a family with a
          sledge. Carpe Diem as they say and I was of a mind to take a trek
          right then. But sensibleness prevailed. It was a bit busy for my
          liking; anything more than 2 people counts as a crowd in Rob’s world
          of hiking. I wasn’t really prepared, only having jeans and wearing my
          running shoes. And I was free for the next couple of days when I
          assumed it would be far less busy. So I returned home, after getting
          my fancy coffee, and planned a proper trek for the Tuesday, when the
          weather looked good, albeit super cold.
        </p>

        <blockquote>
          <p>"I discovered Val Duron by accident"</p>
        </blockquote>

        <p>
          The brief respite also gave me time to contact my friend Katie. She
          has worked several seasons in the Dolomites and knows the territory
          around Val di Fassa well. As I suspected she was aware of Val Duron
          and informed me it was hikeable in winter and was well worth the
          effort.
        </p>
